...
experiment=pretrain-finetune-base
...
train_src=$DATA_DIR/bea19.blimp.train.src
train_trg=$DATA_DIR/bea19.blimp.train.trg
valid_src=$DATA_DIR/bea19.blimp.valid.src
valid_trg=$DATA_DIR/bea19.blimp.valid.trg
test_src=$DATA_DIR/bea19.blimp.valid.src
test_trg=$DATA_DIR/bea19.blimp.valid.trg
