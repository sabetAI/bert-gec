...
train_src=$DATA_DIR/train.1M.cxt.src
train_trg=$DATA_DIR/train.1M.cxt.trg
valid_src=$DATA_DIR/train.1K.cxt.src
valid_trg=$DATA_DIR/train.1K.cxt.trg
test_src=$DATA_DIR/train.1K.cxt.src
test_trg=$DATA_DIR/train.1K.cxt.trg
