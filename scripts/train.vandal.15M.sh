...
train_src=$DATA_DIR/dropna.trg
train_trg=$DATA_DIR/dropna.src
valid_src=$DATA_DIR/dropna.1K.trg
valid_trg=$DATA_DIR/dropna.1K.src
test_src=$DATA_DIR/dropna.1K.trg
test_trg=$DATA_DIR/dropna.1K.src
